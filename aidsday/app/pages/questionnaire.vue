...
<template>
  <div
    ...
    <!--调查问卷提示-->
    <div v-show="qsTip"
         class="fixed inset-0 flex flex-col items-center justify-center max-w-[18.75rem] mx-auto p-6 z-50">
    ...
    <!--问卷-->
    <div v-show="qsDom"
         class="fixed inset-0 flex flex-col items-center justify-center max-w-[18.75rem] mx-auto p-4 z-50">
      <div class="popup-box w-full max-w-sm md:max-w-md px-3 pt-2 pb-6">
        <div class="text-center mb-[1rem]">
            <span class="inline-flex items-center justify-center p-2 rounded-full relative">
                <span class="text-yellow-600 font-bold text-[0.85rem] px-2">调查问卷</span>
            </span>
        </div>
        <div class="mb-[1rem]">
    ...
    <!--答题完成|达人-->
    <div v-show="statue && rightnum>=8"
         class="fixed inset-0 flex flex-col items-center justify-center max-w-[18.75rem] h-full mx-auto p-6 z-30">
    ...
    <div v-show="statue && rightnum<8"
      ...
      <div class="popup-box w-full max-w-sm md:max-w-md px-6 pt-2 pb-6 relative z-10">
        ...
        <div class="text-center pt-24 pb-4">
          ...
          <p class="text-[0.75rem] text-gray-600 text-left">了解正确的知识，是我们携手抗击艾滋病的第一步。
            不如再来挑战一次吧！</p>
        </div>
